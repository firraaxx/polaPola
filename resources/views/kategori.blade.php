        ...
        {{-- <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <li><a href="{{'/shop'}}" class="active">Semua</a></li>
                    <li><a href="{{'/bahan_mentah'}}">Bahan Mentah</a></li>
                    <li><a href="{{'/bahan_pokok'}}">Bahan Pokok</a></li>
                    <li><a href="{{'/lain_lain'}}">Lain-Lain</a></li>
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="bottom-area d-flex px-3">
                            <div class="m-auto d-flex">
                                <a href="{{url('/show', $product->id)}}" class="add-to-cart d-flex justify-content-center align-items-center text-center">
